...
script_body() {
    ...
    $IPTABLES -A INPUT  ! -s 221.13.1.1 --dport 22 -m state --state NEW  -j DROP
    $IPTABLES -A FORWARD -i eth3 -o eth1 -p tcp --syn --dport 22 ! -s 221.13.1.1 -m conntrack --ctstate NEW -j DROP
