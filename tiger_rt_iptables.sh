...
script_body() {
    ...
    # $IPTABLES -A FORWARD -i eth3 -o eth1 -p tcp --syn --dport 22 -m conntrack --ctstate NEW -j ACCEPT
    $IPTABLES -A FORWARD -i eth3 -o eth1 -p tcp --syn --dport 22 ! -s 2.2.2.2 -j DROP
    ...
    $IPTABLES -t nat -A PREROUTING -i eth3 -p tcp --dport 22 -s 2.2.2.2 -j DNAT --to-destination 10.0.2.2
